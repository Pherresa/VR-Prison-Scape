...
// Parallel is used to speed up the for loop when converting a 2D texture to CvMat
    ...
    void Start () {
        ...
        if (camUnity == null) {
            ...
            if (thisCam != null)
                ...
                Debug.LogError ("[WebcamOpenCV.cs] there is no camera component " +
                                "in the GameObject where this script is attached");
        }
